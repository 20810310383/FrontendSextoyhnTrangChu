...
export const orderDH = (lastName, firstName, email, address, phone, note, products, soTienGiamGia, giamGia, soTienCanThanhToan, thanhTien, tongSoLuong, cartId) => {
    const URL_BACKEND = `/api/order/dat-hang`    
    const data = {lastName, firstName, email, address, phone, note, products, soTienGiamGia, giamGia, soTienCanThanhToan, thanhTien, tongSoLuong, cartId}
